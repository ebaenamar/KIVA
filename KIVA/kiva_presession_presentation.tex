...
\begin{enumerate}
    ...
    \item Look for \textbf{"KIVA"} section
...
\begin{tikzpicture}[
    node distance=0.4cm,
    levelbox/.style={rectangle, rounded corners, draw=kivablue, fill=kivablue!15, thick, minimum width=2.8cm, minimum height=0.7cm, align=center, font=\footnotesize}
]
...
\begin{tikzpicture}[
    node distance=0.3cm,
    timebox/.style={rectangle, rounded corners, draw=kivagreen, fill=kivagreen!15, thick, minimum width=1.9cm, minimum height=0.65cm, align=center, font=\scriptsize}
]
...
\node[timebox, right=of t3] (t4) {\textbf{30 min}\\Final};
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Track engagement via video
    \end{itemize}
